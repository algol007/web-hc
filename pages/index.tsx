    ...
    <div>
      ...
      <nav className="bg-white dark:bg-gray-800 shadow border-b">
        <div className="container mx-auto">
          ...
          <div id="toggle-nav" className="hidden">
      ...
      <div className="bg-primary py-16">
        <div className="container mx-auto dark:bg-gray-800 overflow-hidden relative px-4 lg:px-0">
          <div className="text-start lg:w-1/2 py-16 pr-4 sm:pr-6 lg:py-16 lg:pr-8 z-20">
      ...
      <section id="testimonial" className="container mx-auto py-16">
        <div className="w-full flex flex-col lg:flex-row mb-8 md:mb-0 justify-center items-center">
